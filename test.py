...
# Update format explanation
guesser_prompt = "You are the guesser. You need to select which words you think are related to the clue. The hint you are receiving is formatted as \['hints', a number n]. 'hints' is the clue, and the number 'n' represents the number of valid words related to the clue in the grids. The output of your answer should contain only the words you guess, formatted as \['word']."
